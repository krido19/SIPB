...
function submit(x) {
    if (x == 'add') {
        ...
        $('[name="unitkerja_id"]').val("").trigger('change');
        $('[name="supplier_id"]').val("").trigger('change');
        $('[name="keterangan"]').val("");
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('[name="unitkerja_id"]').val(data.unitkerja_id).trigger('change');
            ...
            <form action="<?=base_url();?>process/barang.php" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="unitkerja_id">Unit Kerja <span class="text-danger">*</span></label>
                                <select name="unitkerja_id" id="unitkerja_id" class="form-control select2" style="width:100%;"
                                    required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="supplier_id">Supplier Barang <span class="text-danger">*</span></label>
