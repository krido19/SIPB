...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="#" class="btn btn-primary btn-icon-split btn-sm" data-toggle="modal" data-target="#supplierModal">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php 
                        $n=1;
                        $query = mysqli_query($con,"SELECT * FROM supplier ORDER BY idsupplier DESC")or die(mysqli_error($con));
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?=base_url();?>/process/supplier.php?act=<?=encrypt('delete');?>&id=<?=encrypt($row['idsupplier']);?>"
...
<div class="modal fade" id="supplierModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?=base_url();?>process/supplier.php" method="post">
