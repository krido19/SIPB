...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">SI Persediaan Barang <sup>v1</sup></div>
    </a>
   ...
   <li class="nav-item <?=isset($laporan)?'active':'';?>">
        ...
        <div id="laporan" class="collapse <?=isset($laporan)?'show':'';?>" aria-labelledby="headingTwo"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item <?=isset($lap_barang_masuk)?'active':'';?>" href="?lap_barang_masuk">Laporan Barang Masuk</a>
                <a class="collapse-item <?=isset($lap_barang_keluar)?'active':'';?>" href="?lap_barang_keluar">Laporan Barang Keluar</a>
    ...
    <li class="nav-item <?=isset($master)?'active':'';?>">
        ...
        <div id="master" class="collapse <?=isset($master)?'show':'';?>" aria-labelledby="headingTwo"
            data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item <?=isset($unit_kerja)?'active':'';?>" href="?unit_kerja">Unit Kerja</a>
                <a class="collapse-item <?=isset($supplier)?'active':'';?>" href="?supplier">Supplier</a>
